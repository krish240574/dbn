 z←li kcontdiv x;count;cdn;l;b;w;lr;nin;v0;h0hat;biash;h1hat;biasv;v1;input;updates
 ⍝ CD-n
 count←⊃li[1]
 ...
 nin←((-1)↑(⍴b))
 v0←(1,nin)⍴⊃x[1]
 h0hat←(1,nin)⍴⊃x[1] ⍝ initialize posterior of visible as input
...
⍝ ⎕←'3. Values of visible layer after CD1
 ...
 b[l;]←((1,nin)⍴b[l;])+lr×(h0hat-h1hat)
 b[l-1;]←((1,nin)⍴b[l;])+lr×(v0-v1)
